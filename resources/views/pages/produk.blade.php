...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
            <div>
                <p class="text-gray-500 max-w-md italic">Barang pilihan berkualitas dari berbagai penjual terpercaya di seluruh Indonesia.</p>
            </div>
            <div class="flex items-center gap-3">
                <span class="text-xs font-bold text-gray-400 uppercase">Urutkan:</span>
                <select class="px-4 py-2.5 bg-white border border-gray-100 rounded-xl text-sm font-bold text-gray-700 shadow-sm focus:ring-2 focus:ring-green-700 outline-none">
                ...
                <div class="bg-white rounded-3xl p-8 shadow-sm border border-gray-50 sticky top-24">
                        ...
                        <div class="space-y-3">
                            <label class="flex items-center group cursor-pointer">
                                <div class="relative flex items-center">
                                    <input type="checkbox" class="peer h-5 w-5 cursor-pointer appearance-none rounded-md border border-gray-200 transition-all checked:bg-green-700 checked:border-green-700" />
                                ...
                                <span class="ml-3 text-sm font-medium text-gray-600 group-hover:text-green-700">Pakaian</span>
                            </label>
                            </div>
                    </div>

                    <div class="mb-8">
                        <h4 class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-4">Rentang Harga</h4>
                        <div class="space-y-4">
                            <div class="relative">
                                <span class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 text-xs font-bold">Rp</span>
                                <input type="number" placeholder="Min" class="w-full pl-10 pr-4 py-3 bg-stone-50 border-none rounded-xl text-sm focus:ring-2 focus:ring-green-700">
                            </div>
                            <div class="relative">
                                <span class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 text-xs font-bold">Rp</span>
                                <input type="number" placeholder="Max" class="w-full pl-10 pr-4 py-3 bg-stone-50 border-none rounded-xl text-sm focus:ring-2 focus:ring-green-700">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <button class="px-4 py-2 rounded-full border border-gray-100 text-xs font-bold bg-green-50 text-green-700">Tersedia</button>
                            <button class="px-4 py-2 rounded-full border border-gray-100 text-xs font-bold text-gray-500 hover:bg-gray-50">Habis</button>
                        </div>
                    </div>
                </div>
            </aside>
            ...
            <main class="flex-1">
                    ...
                    <div class="bg-white rounded-[2rem] overflow-hidden border border-gray-50 shadow-sm hover:shadow-2xl transition-all duration-500 group relative">
                            ...
                            <div class="p-6">
                                <div class="flex justify-between items-start mb-2">
                                    <span class="text-[10px] font-bold text-green-700 uppercase tracking-widest">Kategori Nama</span>
                                    <div class="flex items-center text-orange-400 text-xs font-bold">
                                        <i class="fa-solid fa-star mr-1"></i>
                                        <span class="text-gray-900">4.8</span> </div>
                                </div>
                                ...
                                <p class="text-[10px] text-gray-400 mb-4 uppercase font-bold italic">
                                    <i class="fa-solid fa-shop mr-1"></i> Nama Toko </p>
                ...
                <div class="mt-20 flex justify-center">
                    <nav class="flex items-center space-x-2 bg-white p-2 rounded-2xl shadow-sm border border-gray-50">
                        <button class="w-10 h-10 flex items-center justify-center rounded-xl hover:bg-stone-50 text-gray-400"><i class="fa-solid fa-chevron-left"></i></button>
                        <button class="w-10 h-10 flex items-center justify-center rounded-xl bg-green-700 text-white font-bold shadow-lg shadow-green-100">1</button>
                        <button class="w-10 h-10 flex items-center justify-center rounded-xl hover:bg-stone-50 text-gray-600 font-bold">2</button>
                        <button class="w-10 h-10 flex items-center justify-center rounded-xl hover:bg-stone-50 text-gray-400"><i class="fa-solid fa-chevron-right"></i></button>
                    </nav>
                </div>
            </main>
        </div>
